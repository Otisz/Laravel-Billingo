...
class ProductsUpdateTest extends TestCase
{
    ...
    public function testItCannotUpdateAnExistingProductWithInvalidProperties(): void
    {
        ...
        Products::update($created['id'], $product);
    }

    public function testItCanUpdateAnExistingProductWithMinimalProperties(): void
    {
        $product = $this->productFactory(true);

        $created = Products::store($product);

        $product = $this->productFactory(true);

        $response = Products::update($created['id'], $product);
    ...
    public function testItCanUpdateAnExistingProductWithAllProperties(): void
    {
        $product = $this->productFactory();
