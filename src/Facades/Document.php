 ...
 * @method static array createModificationDocument(int|string $documentID, array $payload)
 ...
 * @method static array paymentsUpdate(int|string $documentID, array $payload)
 * @method static array paymentsDestroy(int|string $documentID)
 * @method static \Illuminate\Http\Client\Response printPOS(int|string $documentID)
